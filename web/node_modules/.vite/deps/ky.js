...
var _Ky = class _Ky {
  ...
  constructor(input, options = {}) {
    ...
    if (hasSearchParameters(this._options.searchParams)) {
      const textSearchParams = typeof this._options.searchParams === "string" ? this._options.searchParams.replace(/^\?/, "") : new URLSearchParams(__privateMethod(_c = _Ky, _Ky_static, normalizeSearchParams_fn).call(_c, this._options.searchParams)).toString();
  ...
  static create(input, options) {
    ...
    const result = (isRetriableMethod ? ky2._retry(function_) : function_()).finally(async () => {
      ...
      if (!ky2.request.bodyUsed) {
        await ((_a2 = ky2.request.body) == null ? void 0 : _a2.cancel());
      }
    });
